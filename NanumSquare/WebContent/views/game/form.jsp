      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">Register Game</h2>
          	<form name="form" method="POST" action="<c:url value='/views/game/form' />" class="bg-light p-5 contact-form">
              	...
              	<label for="name">End Date</label>
	                <div class="d-flex">
		    		  <div class="form-group mr-2">
		                <input type="text" class="form-control" id="book_pick_date" name = "endDate" placeholder="Date"><br>
		                <input type="time" name = "time" id="inputMDEx1" class="form-control">
		              </div>
              		</div>
              </div>
              <div class="form-group">
                <input type="button" value="register" onClick="gameCreate()" class="btn btn-primary py-3 px-5">
              	<input type="button" value="list" onClick="gameList('<c:url value='/views/game/list' />')" class="btn btn-primary py-3 px-5">
              </div>
            </form>      
          </div>
        </div>
