      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">Modify Game</h2>
          	<form name="form" method="POST" action="<c:url value='/views/game/update'/>" class="bg-light p-5 contact-form">
              <div class="form-group">
              	<label for="name">Game No</label>
                <input type="text" name="gameNo" id="gameNo" value="${game.gameNo}" class="form-control" readonly />
              </div>
              <div class="form-group">
              	<label for="name">End Date</label>
	                <div class="d-flex">
		    		  <div class="form-group mr-2">
		    		    <input type="text" name="endDate" id="endDate" value="${endDate}" class="form-control" readonly />
		                <!-- <input type="text" class="form-control" id="book_pick_date" name = "endDate" placeholder="Date"> -->
		                <input type="time" name = "time" id="inputMDEx1" class="form-control">
		              </div>
              		</div>
              </div>
              <div class="form-group">
                <input type="button" value="modify" onClick="gameUpdate()" class="btn btn-primary py-3 px-5">
              	<a href="<c:url value='/views/game/list'></c:url>" class="btn btn-primary py-3 px-5">list</a>
              </div>
            </form>      
          </div>
        </div>
