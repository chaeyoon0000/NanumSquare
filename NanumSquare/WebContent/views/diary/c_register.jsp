	...
	<section class="ftco-section contact-section">
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
            ...
            <!-- insertReComment form  -->
            
            <form name="form" method="POST" action="<c:url value='/views/comment_d_c/register'/>" class=bg-light p-5 contact-form">
            
              <input type="hidden" name="commentNo" value="${commentNo}" />
              <input type="hidden" name="diaryNo" value="${diaryNo}" />
              
              <div class="form-group">
                <textarea name="content" cols="30" rows="7" class="form-control" placeholder="ReComment를 달아주세요"></textarea>
              </div>
         
              <div class="form-group">
                <input type="submit" value="Save" class="btn btn-primary py-3 px-5" onClick="c_Insert()">
              </div>
