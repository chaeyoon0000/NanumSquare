...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    </section><br><br><br><hr><br><br><br>

	<div class="container">
		<a href="/NanumSquare/views/diary/register/form"><button type="button" class="btn btn-primary py-3 px-5">Write</button></a><br><br>
   
		 <section class="ftco-section">
	   		<div>
	   			<h4><b>Friend List</b></h4>
		      	<c:forEach var="uf" items="${friendList}">
		      	<table class="table">
		      		<tbody>
		      			<tr><td width="50%" align="center">
						<a href="<c:url value='/views/diary/s_user'>
						<c:param name='user' value='${uf.friendId}'/>
						</c:url>">${uf.friendId}</a>
						</td></tr>
					</tbody>
				</table>
