      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	...
          	<form name="form" method="POST" enctype="multipart/form-data" action="<c:url value='/views/circle/form' />" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
              	<label for="name">Category</label>
                	<select id="catNo" name = "catNo" class="form-control">
	    	  ...
	    	  <div class="form-group">
	    			<label for="" class="label">Recruit</label>
	    			<input name="max" id="max" type="text" class="form-control" placeholder="Recruit #">
	    	  </div>
              <div class="form-group">
