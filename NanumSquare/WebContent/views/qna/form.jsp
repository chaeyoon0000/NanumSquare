	...
	<section class="ftco-section contact-section">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">If you have any questions, please leave them here</h2>
            <!-- insertQnA form  -->
            <form name="form" method="POST" action="<c:url value='/views/qna/write'/>" class=bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input type="submit" value="Save" class="btn btn-primary py-3 px-5" onClick="insertQnA()">
              </div>
            </form>
          </div> 
        </div>
