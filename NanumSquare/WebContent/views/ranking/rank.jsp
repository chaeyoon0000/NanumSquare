		...
		<div class="container">
			<div
				...
				<div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
					<div class="text">
						<h1 class="mb-4">
							Now <span>It's easy for you</span> <span>use a </span> <span>"Nanum
								Square"</span>
						</h1>
				...
				<div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
					<form name="form" method="GET"
						action="<c:url value='/views/user/login' />"
						...
						<c:if test="${empty sessionScope.userId}">
							...
							<div class="form-group">
								<label for="" class="label">ID</label> <input type="text"
									name="id" class="form-control" placeholder="Input Your ID">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="button" value="login" onClick="login()"
									...
									href="<c:url value='/views/user/register'></c:url>">register</a>
						...
						<c:if test="${!empty sessionScope.userId}">
							...
							<div class="form-group">
								<input type="button" value="logout"
									onClick="userCreate('<c:url value='/views/user/logout' />')"
									class="btn btn-primary py-3 px-5">
							</div>
						</c:if>
					</form>
		...
		<div class="container">
			<div class="row no-gutters">
				<div
					...
					style="width:50;background-image: url('<%=request.getContextPath()%>/images/about.png');">
				</div>
				<div class="col-md-6 wrap-about py-md-5 ftco-animate">
					<div class="heading-section mb-5 pl-md-5">
						...
						<p>On her way she met a copy. The copy warned the Little Blind
							...
							could convince her and so it didnât take long until a few
							...
							her for their.</p>
						<p>
							<a href="<%=request.getContextPath()%>/views/user/register"
