      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
             <p class="breadcrumbs"><span class="mr-2"><a href="/NanumSquare/views/home">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Diary <i class="ion-ios-arrow-forward"></i></span></p>
...
<!--  <a href="<c:url value='/diary/register/form' />">사용자 추가</a> -->
     ...
     <section class="ftco-section">
    	<div class="container">
    		<div class="block-27">
	   			<a href="/NanumSquare/views/diary/register/form"><button type="button" class="btn btn-primary py-3 px-5">Write</button></a><br><br><br>
			</div>
    		<div class="row">
    			...
    			<c:if test="${!empty diaryList}">
				 <div class="col-md-3">
    				<div class="car-wrap ftco-animate">
    					<div class="img d-flex align-items-end" style="background-image: url('<%=request.getContextPath()%>/images/categoryMain.PNG');">
    					...
    					<div class="text p-4 text-center">
    						<h2 class="mb-0"><a href="/NanumSquare/views/diary/detail?diaryNo=${diary.diaryNo}">${diary.content}</a></h2>
